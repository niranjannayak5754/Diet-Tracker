...
import com.shadycoding.onboarding_presentation.components.SelectableButton
        ...
        Column(
            ...
            Row {
                SelectableButton(
                    ...
                    isSelected = viewModel.goalTypeSelected is GoalType.LoseWeight,
                ...
                SelectableButton(
                    ...
                    isSelected = viewModel.goalTypeSelected is GoalType.KeepWeight,
                    color = MaterialTheme.colors.primaryVariant,
                    selectedTextColor = Color.White,
                    onClick = {
                ...
                SelectableButton(
                    ...
                    isSelected = viewModel.goalTypeSelected is GoalType.GainWeight,
                    color = MaterialTheme.colors.primaryVariant,
                    selectedTextColor = Color.White,
                    onClick = {
